...
#
# Production code: [`professional_rag_kit.production.generation`](../../professional_rag_kit/production/generation/__init__.py)
...
# %%
from professional_rag_kit.production.generation import ABSTENTION
