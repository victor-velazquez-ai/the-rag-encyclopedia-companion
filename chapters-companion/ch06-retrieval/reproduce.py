...
re-score, read the delta. This delegates to the shared reproduction suite (professional_rag_kit.eval.suite).

    python chapters-companion/ch06-retrieval/reproduce.py
"""
