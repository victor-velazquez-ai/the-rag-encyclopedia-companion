...
|---|---|---|---|
| 1 | `01_hybrid_parsing.ipynb` · `01_hybrid_parsing.py` | Detector-first hybrid parse — MinerU 2.5 / PaddleOCR-VL (§ "The three architectures") | [`professional_rag_kit/ingestion/parsing/hybrid.py`](../../professional_rag_kit/ingestion/parsing/) |
| 2 | `02_pure_vlm.ipynb` | Pure end-to-end VLM parse — dots.ocr (§ "The shipping models, compared") | [`professional_rag_kit/ingestion/parsing/vlm.py`](../../professional_rag_kit/ingestion/parsing/) |
| 3 | `03_classical_ocr.ipynb` | Zero-hallucination classical OCR (§ "The three architectures") | [`professional_rag_kit/ingestion/parsing/classical.py`](../../professional_rag_kit/ingestion/parsing/) |
| 4 | `04_reading_order.ipynb` | Layout-aware reading order on multi-column pages (§ "Layout-aware parsing and reading order") | [`professional_rag_kit/ingestion/parsing/hybrid.py`](../../professional_rag_kit/ingestion/parsing/) |
| 5 | `05_tables_to_html.ipynb` · `05_tables_to_html.py` | Table extraction + HTML serialization, TEDS (§ "Table extraction and serialization") | [`professional_rag_kit/ingestion/parsing/tables.py`](../../professional_rag_kit/ingestion/parsing/) |
| 6 | `06_charts_and_figures.ipynb` | Chart/figure surrogates — the untrusted-number warning (§ "Figures, charts, and formulas") | [`professional_rag_kit/ingestion/parsing/figures.py`](../../professional_rag_kit/ingestion/parsing/) |

## The experiment — `reproduce.py`

```bash
make ch02            # launch the notebooks
python chapters-companion/ch02-document-processing/reproduce.py   # or just the headline experiment
```
...
```python
from professional_rag_kit.ingestion.parsing import parse
...
`make setup && make up` (installs `professional_rag_kit`, loads sample data, starts Qdrant). This is the first
