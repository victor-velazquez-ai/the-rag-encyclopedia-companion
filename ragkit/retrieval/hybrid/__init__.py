...
from ragkit.retrieval.hybrid.bm25 import BM25, tokenize
...
class HybridRetriever:
    ...
    bm25: BM25
    embedder: object | None = None  # ragkit.ingestion.embedding.Embedder
    store: object | None = None  # ragkit.ingestion.indexing.VectorStore
    k: int = 60
