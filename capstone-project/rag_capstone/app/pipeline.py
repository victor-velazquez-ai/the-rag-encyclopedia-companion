...
from professional_rag_kit.production.generation import ABSTENTION, GroundedAnswer
from professional_rag_kit.production.security import InjectionDetector, PIIRedactor
...
from professional_rag_kit.retrieval.routing import ComplexityClassifier
...
class ExtractiveAnswerer:
    ...
    def generate(self, query: str, passages: Sequence[str], **_) -> GroundedAnswer:
        from professional_rag_kit.retrieval.hybrid.bm25 import tokenize
