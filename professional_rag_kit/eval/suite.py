"""professional_rag_kit.eval.suite — the reproduction runner behind `make reproduce` (Book Ch 14).

`python -m professional_rag_kit.eval.suite` re-runs the book's head-to-head comparisons on the version-controlled
...
def main(argv: list[str] | None = None) -> None:
    ap = argparse.ArgumentParser(description="professional_rag_kit reproduction suite")
