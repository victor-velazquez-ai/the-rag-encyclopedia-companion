"""professional_rag_kit.production — Part IV: making a correct system survivable in production (Book Ch 13, 15, 16).
...
proves any of this moved a number — is its own top-level module, `professional_rag_kit.eval` (Ch 14).

Phase-1 scaffold. Phase 2 exports the top-level conveniences listed below.
"""

from professional_rag_kit.production.generation import GroundedAnswer, GroundedGenerator
from professional_rag_kit.production.observability import psi, psi_alert, trace
from professional_rag_kit.production.security import InjectionDetector, PIIRedactor, enforce_acl
from professional_rag_kit.production.serving import ModelRouter, SemanticCache
