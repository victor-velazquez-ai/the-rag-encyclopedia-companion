"""professional_rag_kit.architectures — Part III: structures and control loops beyond flat retrieval (Book Ch 9–12).
...
from professional_rag_kit.architectures.agentic import AgenticRAG, EntityResolver, MCPSource
from professional_rag_kit.architectures.graph import GraphIndex
from professional_rag_kit.architectures.hierarchical import ParentChildIndex, RaptorTree
