"""professional_rag_kit.architectures.graph — knowledge-graph RAG (Book Ch 9).
...
LLM calls go through ``professional_rag_kit.core.config.ProviderRegistry`` — no vendor SDK is imported at module
