"""professional_rag_kit.ingestion — Part I: turning documents into searchable vectors (Book Ch 2–5).
...
from professional_rag_kit.ingestion.indexing import VectorStore
