...
|---|---|---|---|
| 1 | `01_ocr_then_embed_loses_information.ipynb` | Why the OCR/layout/chunk cascade leaks — and what it costs (§ "Why OCR-then-embed loses information") | [`ragkit/architectures/multimodal/`](../../ragkit/architectures/multimodal/) |
| 2 | `02_colpali_colqwen.ipynb` · `02_colpali_colqwen.py` | Visual document retrieval — page image + MaxSim late interaction; ColQwen2.5 backbone (§ "Visual document retrieval") | [`ragkit/architectures/multimodal/colpali.py`](../../ragkit/architectures/multimodal/) |
| 3 | `03_token_pooling.ipynb` · `03_token_pooling.py` | Token pooling — −66.7% vectors, −2.2% quality, the day-one storage mitigation (§ "The tradeoff and where it breaks") | [`ragkit/architectures/multimodal/colpali.py`](../../ragkit/architectures/multimodal/) |
| 4 | `04_unified_vs_late_interaction.ipynb` | CLIP/SigLIP unified space vs. multi-vector late interaction — pick by what the query points at (§ "Unified versus separate multimodal embedding spaces") | [`ragkit/architectures/multimodal/unified.py`](../../ragkit/architectures/multimodal/) |
| 5 | `05_native_object_embedding.ipynb` | Charts/tables/figures embedded natively vs. image-to-text summaries (§ "Retrieving images, tables, and charts as first-class objects") | [`ragkit/architectures/multimodal/objects.py`](../../ragkit/architectures/multimodal/) |

## The experiment — `reproduce.py`

```bash
make ch12            # launch the notebooks
python chapters/ch12-multimodal/reproduce.py   # or just the headline experiment
```
...
`make setup && make up` (installs `ragkit`, loads sample data, starts Qdrant). The MaxSim late-
