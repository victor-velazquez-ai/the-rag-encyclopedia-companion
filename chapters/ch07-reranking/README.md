...
|---|---|---|---|
| 1 | `01_cross_encoder.ipynb` · `01_cross_encoder.py` | Cross-encoder reranking — jina-reranker-v3 (§ "Cross-encoder rerankers") | [`ragkit/retrieval/rerank/cross_encoder.py`](../../ragkit/retrieval/rerank/) |
| 2 | `02_listwise_llm.ipynb` | Listwise LLM reranking — RankZephyr-style (§ "Listwise LLM rerankers") | [`ragkit/retrieval/rerank/listwise.py`](../../ragkit/retrieval/rerank/) |
| 3 | `03_colbert_tier.ipynb` | ColBERT late-interaction tier (§ "Late interaction as a reranker") | [`ragkit/retrieval/rerank/colbert.py`](../../ragkit/retrieval/rerank/) |
| 4 | `04_cascade.ipynb` · `04_cascade.py` | Multi-stage cascade + latency budgeting (§ "Cascade ranking") | [`ragkit/retrieval/rerank/cascade.py`](../../ragkit/retrieval/rerank/) |

## The experiment — `reproduce.py`

```bash
make ch07            # launch the notebooks
python chapters/ch07-reranking/reproduce.py   # or just the headline experiment
```
...
`make setup && make up` (installs `ragkit`, loads sample data, starts Qdrant). First-stage
