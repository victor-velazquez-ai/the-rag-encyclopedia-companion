...
|---|---|---|---|
| 1 | `01_context_faithful_prompting.ipynb` · `01_context_faithful_prompting.py` | Opinion-based framing + counterfactual demonstrations — the free default (§ "Context-Faithful Prompting") | [`ragkit/production/generation/`](../../ragkit/production/generation/) |
| 2 | `02_chain_of_note.ipynb` | Per-document reading notes before answering — the noisy-retrieval filter, +7.9 EM (§ "Chain-of-Note") | [`ragkit/production/generation/`](../../ragkit/production/generation/) |
| 3 | `03_context_aware_decoding.ipynb` · `03_context_aware_decoding.py` | CAD — training-free contrastive decoding, +14.3% factuality (§ "Context-Aware Decoding (CAD)") | [`ragkit/production/generation/`](../../ragkit/production/generation/) |
| 4 | `04_span_citation.ipynb` · `04_span_citation.py` | Span-level citation scored ALCE-style (recall + precision) via an NLI judge (§ "Citation and attribution") | [`ragkit/production/generation/`](../../ragkit/production/generation/) |
| 5 | `05_abstention.ipynb` | Sufficiency gate → first-class "the sources do not support an answer" output (§ "Abstention as a first-class design choice") | [`ragkit/production/generation/`](../../ragkit/production/generation/) |
| 6 | `06_conflict_arbitration.ipynb` | Source-reliability weighting + surface-the-disagreement for conflicting evidence (§ "Conflicting and insufficient evidence") | [`ragkit/production/generation/`](../../ragkit/production/generation/) |

## The experiment — `reproduce.py`

```bash
make ch13            # launch the notebooks
python chapters/ch13-grounded-generation/reproduce.py   # or just the headline experiment
```
...
`make setup && make up` (installs `ragkit`, loads sample data, starts Qdrant). The context that feeds
