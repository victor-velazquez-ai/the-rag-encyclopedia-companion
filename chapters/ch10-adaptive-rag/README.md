...
|---|---|---|---|
| 1 | `01_parent_child.ipynb` · `01_parent_child.py` | Parent-child / small-to-big / auto-merging — the default hierarchy (§ "Parent-child, small-to-big, and auto-merging") | [`ragkit/architectures/hierarchical/parent_child.py`](../../ragkit/architectures/hierarchical/) |
| 2 | `02_raptor_collapsed_tree.ipynb` · `02_raptor_collapsed_tree.py` | RAPTOR — UMAP+GMM summary tree, collapsed-tree retrieval (§ "RAPTOR") | [`ragkit/architectures/hierarchical/raptor.py`](../../ragkit/architectures/hierarchical/) |
| 3 | `03_adaptive_rag_routing.ipynb` · `03_adaptive_rag_routing.py` | Adaptive-RAG — route by complexity to no/single/multi-step (§ "Adaptive-RAG") | [`ragkit/architectures/adaptive/adaptive_rag.py`](../../ragkit/architectures/adaptive/) |
| 4 | `04_crag.ipynb` | CRAG — grade retrieval, then correct (refine / web fallback / both) (§ "CRAG") | [`ragkit/architectures/adaptive/crag.py`](../../ragkit/architectures/adaptive/) |
| 5 | `05_self_rag.ipynb` | Self-RAG — segment-level support critique as a pattern (§ "Self-RAG") | [`ragkit/architectures/adaptive/self_rag.py`](../../ragkit/architectures/adaptive/) |
| 6 | `06_flare.ipynb` | FLARE — retrieve on low-confidence spans mid-generation (§ "FLARE") | [`ragkit/architectures/adaptive/flare.py`](../../ragkit/architectures/adaptive/) |
| 7 | `07_composing_the_guards.ipynb` | Composing all four as guards on one pipeline (§ "The synthesis") | [`ragkit/architectures/adaptive/`](../../ragkit/architectures/adaptive/) |

## The experiment — `reproduce.py`

```bash
make ch10            # launch the notebooks
python chapters/ch10-adaptive-rag/reproduce.py   # or just the headline experiment
```
...
```python
from ragkit.architectures.hierarchical import HierarchicalRetriever
from ragkit.architectures.adaptive import AdaptiveRouter
...
`make setup && make up` (installs `ragkit`, loads sample data, starts Qdrant). The flat retrieval
