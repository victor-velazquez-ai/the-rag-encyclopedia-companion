...
|---|---|---|---|
| 1 | `01_hybrid_rrf.ipynb` · `01_hybrid_rrf.py` | BM25 + dense fused with Reciprocal Rank Fusion, k=60 (§ "Hybrid search and Reciprocal Rank Fusion") | [`ragkit/retrieval/hybrid/`](../../ragkit/retrieval/hybrid/) |
| 2 | `02_splade_sparse_leg.ipynb` | SPLADE-v3 learned sparse retrieval — term expansion on one inverted index (§ "Learned sparse retrieval: SPLADE-v3") | [`ragkit/retrieval/hybrid/`](../../ragkit/retrieval/hybrid/) |
| 3 | `03_hyde.ipynb` · `03_hyde.py` | HyDE — hypothetical document embeddings (§ "HyDE") | [`ragkit/retrieval/query/`](../../ragkit/retrieval/query/) |
| 4 | `04_step_back.ipynb` | Step-back prompting — abstract, then retrieve (§ "Step-back prompting") | [`ragkit/retrieval/query/`](../../ragkit/retrieval/query/) |
| 5 | `05_multi_query_decomposition.ipynb` | Multi-query paraphrase + multi-hop decomposition, fused with RRF (§ "Multi-query and decomposition") | [`ragkit/retrieval/query/`](../../ragkit/retrieval/query/) |
| 6 | `06_semantic_routing.ipynb` · `06_semantic_routing.py` | Semantic router — embed + k-NN intent routing (~5000 ms → ~100 ms vs an LLM router) (§ "Semantic routing") | [`ragkit/retrieval/routing/`](../../ragkit/retrieval/routing/) |
| 7 | `07_adaptive_rag_router.ipynb` | Adaptive-RAG complexity classifier — no-retrieval / single-step / multi-step (§ "Adaptive-RAG") | [`ragkit/retrieval/routing/`](../../ragkit/retrieval/routing/) |

## The experiment — `reproduce.py`

```bash
make ch06            # launch the notebooks
python chapters/ch06-retrieval/reproduce.py   # or just the headline experiment
```
...
```python
from ragkit.retrieval import HybridRetriever
...
`make setup && make up` (installs `ragkit`, loads sample data, starts Qdrant). This chapter
