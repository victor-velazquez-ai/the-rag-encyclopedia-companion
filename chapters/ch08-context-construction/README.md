...
|---|---|---|---|
| 1 | `01_lost_in_the_middle_fold.ipynb` · `01_lost_in_the_middle_fold.py` | The zipper fold — strongest evidence first and last (§ "Lost in the middle: position is a feature") | [`ragkit/retrieval/context/`](../../ragkit/retrieval/context/) |
| 2 | `02_rerank_then_truncate.ipynb` | Budget in tokens, not passages; truncate after ranking, reserve answer headroom (§ "Budgeting the window") | [`ragkit/retrieval/context/`](../../ragkit/retrieval/context/) |
| 3 | `03_prompt_compression.ipynb` · `03_prompt_compression.py` | LLMLingua / LongLLMLingua / LLMLingua-2 prompt compression (§ "Prompt compression") | [`ragkit/retrieval/context/`](../../ragkit/retrieval/context/) |
| 4 | `04_mmr_diversity.ipynb` | MMR on the reranked shortlist — kill redundancy, λ≈0.6–0.7 (§ "MMR and diversity") | [`ragkit/retrieval/context/`](../../ragkit/retrieval/context/) |
| 5 | `05_dedup_contradiction.ipynb` | Dedup + inter-context contradiction arbitration (decomposition · source-reliability · recency/authority) (§ "Deduplication and contradiction") | [`ragkit/retrieval/context/`](../../ragkit/retrieval/context/) |
| 6 | `06_self_route_long_context.ipynb` · `06_self_route_long_context.py` | Self-Route — retrieve-and-self-assess vs. stuff the window (§ "Long context versus tighter retrieval") | [`ragkit/retrieval/context/`](../../ragkit/retrieval/context/) |

## The experiment — `reproduce.py`

```bash
make ch08            # launch the notebooks
python chapters/ch08-context-construction/reproduce.py   # or just the headline experiment
```
...
```python
from ragkit.retrieval import ContextBuilder
...
`make setup && make up` (installs `ragkit`, loads sample data, starts Qdrant). The ranked shortlist
